...
const Card = ({ title, url, rate, className, ...props }) => {
  ...
  return (
    <div className="flex items-start w-[300px] h-[265px] flex-col gap-2 border-[1.5px] border-[#FFF5F5] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] cursor-pointer">
      <img
        src={url}
